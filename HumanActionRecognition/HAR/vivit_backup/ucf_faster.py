...
def load_data(data_root="/path/to/your/dataset"):
    ...
    data_subset = sorted(all_classes)
    ...
    # Split data into train (56%), val (14%), test (30%)
    ...
    # Second split: from the 70%, split into 56% train and 14% val (which is 80%/20% of the 70%)
    train_videos, val_videos, train_labels, val_labels = train_test_split(
        train_val_videos, train_val_labels, 
        test_size=0.20,  # 0.20 * 0.70 = 0.14 (14% of total)
        random_state=42, 
